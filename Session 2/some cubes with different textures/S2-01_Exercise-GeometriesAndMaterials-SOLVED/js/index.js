...
var material14 = new THREE.MeshBasicMaterial({map: texture});
...
var mesh2 = new THREE.Mesh( geometry, material6);
...
{var mesh11 = new THREE.Mesh( geometry1, material6 );
mesh11.position.z = -1000;
mesh11.position.x = -100;
mesh11.position.y = -200;

var mesh12 = new THREE.Mesh( geometry1, material6 );
mesh12.position.z = -800;
...
var render = function () {
  ...
  mesh3.rotation.x = rot+5; //Continuously rotate the mesh
  mesh3.rotation.y = rot+5;
  ...
  mesh10.rotation.x = rot+5; //Continuously rotate the mesh
  mesh10.rotation.y = rot+5;
